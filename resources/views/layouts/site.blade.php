...
<body>
    ...
    <footer class="footer">
            <div class="footer-column">
              <img src="{{asset('images/logo (1).webp')}}" alt="logo" class="footer-logo">
              ...
              <img src="{{asset('images/hinh2.webp')}}" alt="Payment" width="50" height="50">
              <img src="{{asset('images/hinh3.webp')}}" alt="Payment" width="50" height="50">
              <img src="{{asset('images/hinh4.webp')}}" alt="Payment" width="50" height="50">
            </div>
            ...
            <div class="footer-column">
              ...
              <img src="{{asset('images/hinh5.webp')}}" alt="Link" width="50" height="50">
              <img src="{{asset('images/hinh6.webp')}}" alt="Link" width="50" height="50">
              <img src="{{asset('images/hinh7.webp')}}" alt="Link" width="50" height="50">
              <img src="{{asset('images/hinh8.webp')}}" alt="Link" width="50" height="50">
            </div>
          
            <div class="footer-column">
                <p class="footer-heading">INSTAGRAM</p>
                <img src="{{asset('images/hinh9.webp')}}" alt="Instagram" width="80" height="80">
                <img src="{{asset('images/hinh10.webp')}}" alt="Instagram" width="80" height="80">
                <img src="{{asset('images/hinh11.webp')}}" alt="Instagram" width="80" height="80">
                <img src="{{asset('images/hinh12.webp')}}" alt="Instagram" width="80" height="80">
                <img src="{{asset('images/hinh16.webp')}}" alt="Instagram" width="80" height="80">
                <img src="{{asset('images/hinh15.webp')}}" alt="Instagram" width="80" height="80">
              </div>
